...
<div class="je-p10">
    ...
    <blockquote class="je-quote je-f14 je-mb20">

        <div class="je-ovh" style="line-height:50px;">
        <p class="je-fl je-mr30" style="font-size: 300%;">您的系统 <span<?php if( $authinfo=='未授权' ){ ?> style="color: red;"<?php } ?>><?php echo $authinfo;?></span> <a href="main?updateAuth=1" class="je-btn je-bg-green je-btn-small je-white je-f14">刷新授权</a><?php if( $authinfo=='未授权' ){ ?> <a href="main?updateAuth=1" class="je-btn je-bg-red je-btn-small je-white je-f14">购买授权</a><?php } ?></p>
        </div>
    </blockquote>
    
    <!--
    <div class="je-row-ml je-ovh je-mt20 je-boxsiz">
        <div class="je-wlg33 je-wmd33 je-wsm33 je-wmn100 je-fl je-pl10 je-pb10 je-boxsiz">
            <div class="linebox">
                <h3 class="linetit je-f14 je-pl10">环形图</h3>
                <div class="linecon" style="height:300px;" id="supplier"></div>
            </div>
        </div>
        <div class="je-wlg33 je-wmd33 je-wsm33 je-wmn100 je-fl je-pl10 je-pb10 je-boxsiz">
            <div class="linebox">
                <h3 class="linetit je-f14 je-pl10">折线图堆叠</h3>
                <div class="linecon" style="height:300px;" id="stack"></div>
            </div>
        </div>
        <div class="je-wlg33 je-wmd33 je-wsm33 je-wmn100 je-fl je-pl10 je-pb10 je-boxsiz">
            <div class="linebox">
                <h3 class="linetit je-f14 je-pl10">坐标轴刻度与标签对齐</h3>
                <div class="linecon" style="height:300px;" id="coordinate"></div>
            </div>
        </div>
    </div>
    <div class="je-row-ml je-ovh je-boxsiz">
        <div class="je-wlg100 je-wmd100 je-wsm100 je-wmn100 je-fl je-pl10 je-pb10 je-boxsiz">
            <div class="linebox">
                <h3 class="linetit je-f14 je-pl10">触屏上的坐标轴指示器</h3>
                <div class="linecon" style="height:380px;" id="touchscreen"></div>
            </div>
        </div>
    </div>
-->
...
jeui.use(["jquery","jeTabs","echarts"],function () {
    ...
    echarts.init(document.getElementById('stack')).setOption( {
        tooltip: {
            trigger: 'axis'
        },
        legend: {
    ...
    echarts.init(document.getElementById('coordinate')).setOption({
        color: ['#0074D9'],
        tooltip : {
            trigger: 'axis',
    ...
    echarts.init(document.getElementById('touchscreen')).setOption({
        animation: false,
        color: colorList,
        title: {
            left: 'center',
